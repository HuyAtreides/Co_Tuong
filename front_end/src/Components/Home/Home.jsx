...
const Home = () => {
  ...
  return (
    <Container fluid>
      <NavBar setWaitForResponse={setWaitForResponse} setRedirect={setRedirect} />
      <Row className='home-row mt-3'>
        <p className='upload-pic-err' style={{ display: error ? 'block' : ' none' }}>
          <i
        ...
        >
          ...
          <MatchHistory playerInfo={playerInfo} viewOthersProfile={Boolean(name)} />
        </Col>
        <Col
          lg={{ span: 4 }}
          md={{ span: 9 }}
